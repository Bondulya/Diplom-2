...
public class Order {
    ...
    public Order(String accessToken){
    ...
    private void initIngresientsList(){
        IngredientsList ingredientsList = given()
                ...
                .when().get(ApiShop.API_INGREDIENTS).as(IngredientsList.class);
    ...
    @Step("Order Create")
    public ValidatableResponse orderCreate(int numIngredients) {
        String strJson = "{\n    \"ingredients\": [";
        String separator;
    ...
    public ValidatableResponse burgerUserOrderList(String accessToken) {
        ...
        ValidatableResponse response = given()
                .auth().oauth2(accessToken.substring(7))
                .header(ApiShop.API_POST_HEADER_TYPE, ApiShop.API_POST_HEADER_VALUE)
                .when().get(ApiShop.API_ORDERS_LIST)
                .then();
